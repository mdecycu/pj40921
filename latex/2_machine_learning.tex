...
\begin{itemize}
	...
	\item 軸設計器(圖.\ref{軸設計器})：\\
		...
		\begin{figure}[hbt!]
		\begin{center}
		\includegraphics[width=12cm]{軸模型}
...
\newpage
	...
	\item 凸輪設計器(圖.\ref{2.11}) :\\
		...
		\begin{figure}[hbt!]
		\begin{center}
		\includegraphics[width=12cm]{凸輪模型}
...
\newpage
	...
	\item 直齒輪設計器(圖.\ref{2.18}) :\\
		...
		\begin{figure}[hbt!]
		\begin{center}
		\includegraphics[width=12cm]{正齒輪模型}
...
\newpage
	...
	\item 錐齒輪設計器(圖.\ref{2.25}) :\\
		...
		\begin{figure}[hbt!]
		\begin{center}
		\includegraphics[width=8cm]{錐齒輪2}
		...
		\begin{figure}[hbt!]
		\begin{center}
		\includegraphics[width=6cm]{錐齒輪3}
		\caption{\Large 設計參數選項}\label{2.27}
		\end{center}
		\end{figure}
		\\
		計算(圖.\ref{2.28}) :\\
		...
		\caption{\Large 設計參數選項}\label{2.28}
		\end{center}
		\end{figure}
		\\
		計算出的幾何參數(圖.\ref{2.29}) :\\
		...
		\caption{\Large 設計參數選項}\label{2.29}
		\end{center}
		\end{figure}
		\\
